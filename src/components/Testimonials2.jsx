...
function Testimonials2() {
    ...
    return (
        <section className="py-12 bg-gray-50 sm:py-16 lg:py-20" id="testimonial_2">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    <div className="text-center">
                        <p className="text-lg font-medium text-gray-600 font-pj">2,157 people have said how good EverLeads</p>
                                ...
                                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                    <div className="flex-1">
                                        ...
                                        <blockquote className="flex-1 mt-8">
                                            <p className="description_bold">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.”</p>
                                        </blockquote>
                                    </div>
                                    ...
                                    <div className="flex items-center mt-8">
                                        ...
                                        <div className="ml-4">
                                            <p className="text-base text-title mt-4 font-bold">Jane Smith</p>
                                            <p className="description_lite mb-2">Freelance React Developer</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col overflow-hidden shadow-xl">
                                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                    ...
                                    <div className="flex items-center mt-8">
                                        ...
                                        <div className="ml-4">
                                            <p className="text-base text-title mt-4 font-bold">John Doe</p>
                                            <p className="description_lite mb-2">Digital Marketer</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col overflow-hidden shadow-xl">
                                <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                                    ...
                                    <div className="flex items-center mt-8">
                                        ...
                                        <div className="ml-4">
                                            <p className="text-base text-title mt-4 font-bold">John Luis</p>
                                            <p className="description_lite mb-2">Graphic Designer</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
